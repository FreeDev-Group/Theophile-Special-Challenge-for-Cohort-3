...
The accessibility of my dashboard allowed me to view all my previously completed surveys

![Dashboard ](./images/past_feedback.png)


# Feedback from my instructor

    I was able to view the question defined by the instuctor along with my corresponding  answer.
...
![Dashboard ](./images/conformite.png)
